...
########----------------------------------------------------------------#########
######## This script processes the detected face image, using OpenCV	#########
######## and produces the coordinates of its detected lines. 			#########
########----------------------------------------------------------------#########
######## Author: Francesca Irimia										#########
########----------------------------------------------------------------#########
...
# Function checks whether a point was already written in the file as part of face line detection
...
def main(argv):	
	...
	dark_bg = int(argv[4])	# Flag indicating which detector should be used
